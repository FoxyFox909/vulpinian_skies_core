...
public class MunitionItemInit {
    ...
    public static final RegistryObject<Item> ETHEREAL_GRENADE = registerEtherealGrenade("ethereal_grenade");

    private static RegistryObject<Item> registerEtherealGrenade(String name) {
        return ITEMS.register(name, () -> new EtherealGrenadeItem(new Item.Properties().tab(ModCreativeModeTab.FOX_TAB), 20 * 4));
    }
}
