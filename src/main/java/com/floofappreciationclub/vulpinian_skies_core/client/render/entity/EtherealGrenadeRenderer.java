...
public class EtherealGrenadeRenderer extends EntityRenderer<EtherealGrenadeEntity> {
    public EtherealGrenadeRenderer(EntityRendererProvider.Context context)
    {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(EtherealGrenadeEntity entity)
    {
        return null;
    }

    @Override
    public void render(EtherealGrenadeEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light)
    {
